  ...
  if (isDemo() && !DEMO_ALLOWED_PATHS.includes(location.pathname)) {
    return (
      <div style={{minHeight:'100vh',background:'#f8fafc',display:'flex',alignItems:'center',justifyContent:'center',fontFamily:'Inter,sans-serif'}}>
        <div style={{background:'#ffffff',border:'1px solid #e2e8f0',borderRadius:16,padding:40,maxWidth:480,textAlign:'center'}}>
          <div style={{fontSize:48,marginBottom:16}}>🔒</div>
          <h2 style={{color:'#1e293b',fontSize:22,fontWeight:700,margin:'0 0 12px'}}>Demo Access Limited</h2>
          ...
          <div style={{display:'flex',gap:12,justifyContent:'center'}}>
            <a href="/workspace" style={{background:'#e2e8f0',borderRadius:8,color:'#475569',padding:'10px 20px',cursor:'pointer',fontSize:13,textDecoration:'none'}}>← Workspace</a>
