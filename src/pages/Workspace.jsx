            ...
            <div style={{background:'#1e293b',border:'1px solid #334155',borderRadius:12,padding:20}}>
              ...
              <div style={{display:'grid',gap:8}}>
                {[
                  ...
                  {label:'Calendar', icon:'CAL', path:'/calendar', color:'#3b82f6'},
                  {label:'KPI Targets', icon:'KPI', path:'/kpi-targets', color:'#10b981'},
                  ...
                  {label:'View Dashboard', icon:'DS', path:'/dashboard', color:'#3b82f6'},
