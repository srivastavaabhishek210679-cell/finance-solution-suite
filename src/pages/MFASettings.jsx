  ...
  return (
    <div style={{minHeight:'100vh',background:'#0f172a',color:'#f1f5f9',fontFamily:'Inter,sans-serif'}}>
      ...
      <div style={{padding:24,maxWidth:600,margin:'0 auto'}}>
        {/* Status Card */}
        <div style={{background:'#1e293b',border:`1px solid ${mfaEnabled?'#10b98140':'#334155'}`,borderRadius:16,padding:24,marginBottom:20}}>
          <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',marginBottom:16}}>
            <div style={{display:'flex',gap:12,alignItems:'center'}}>
              <div style={{width:48,height:48,borderRadius:12,background:mfaEnabled?'#10b98120':'#334155',display:'flex',alignItems:'center',justifyContent:'center',fontSize:24}}>🔐</div>
              <div>
                <h3 style={{color:'#f1f5f9',margin:0,fontSize:16,fontWeight:600}}>Two-Factor Authentication</h3>
        ...
        <div style={{background:'#1e293b',border:'1px solid #334155',borderRadius:16,padding:24,marginBottom:20}}>
          <h3 style={{color:'#f1f5f9',margin:'0 0 16px',fontSize:15,fontWeight:600}}>How MFA Works</h3>
          <div style={{display:'grid',gap:12}}>
            {[
              ...
              <div key={num} style={{display:'flex',gap:12,alignItems:'center'}}>
                ...
                <p style={{color:'#94a3b8',margin:0,fontSize:13}}>{text}</p>
              </div>
            ))}
          </div>
        </div>
        ...
        <div style={{background:'#1e293b',border:'1px solid #334155',borderRadius:16,padding:24}}>
          <h3 style={{color:'#f1f5f9',margin:'0 0 16px',fontSize:15,fontWeight:600}}>Account Information</h3>
          <div style={{display:'grid',gap:10}}>
            <div style={{display:'flex',justifyContent:'space-between',padding:'10px 0',borderBottom:'1px solid #334155'}}>
              ...
              <span style={{color:'#f1f5f9',fontSize:13,fontWeight:600}}>{email}</span>
            </div>
            <div style={{display:'flex',justifyContent:'space-between',padding:'10px 0',borderBottom:'1px solid #334155'}}>
      ...
      {showOTPVerify && (
        <div style={{position:'fixed',inset:0,background:'rgba(0,0,0,0.8)',zIndex:1000,display:'flex',alignItems:'center',justifyContent:'center'}} onClick={()=>setShowOTPVerify(false)}>
          <div style={{background:'#1e293b',border:'1px solid #334155',borderRadius:16,padding:32,width:380,textAlign:'center'}} onClick={e=>e.stopPropagation()}>
            <div style={{fontSize:40,marginBottom:16}}>📧</div>
            <h2 style={{color:'#f1f5f9',margin:'0 0 8px',fontSize:18,fontWeight:700}}>Verify Your Email</h2>
            ...
            <input
              ...
              placeholder="000000"
              maxLength={6}
              style={{width:'100%',background:'#0f172a',border:'1px solid #334155',borderRadius:10,color:'#f1f5f9',padding:'14px',fontSize:28,fontWeight:700,letterSpacing:12,textAlign:'center',boxSizing:'border-box',marginBottom:16}}
            ...
            <div style={{display:'grid',gap:8}}>
              ...
              <button onClick={()=>{setShowOTPVerify(false);setOtp('')}} style={{background:'#334155',border:'none',borderRadius:10,color:'#94a3b8',padding:'12px',cursor:'pointer',fontSize:13}}>Cancel</button>
            </div>
