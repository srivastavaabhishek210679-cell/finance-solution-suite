              ...
              <div className="relative">
                ...
                {showUserMenu&&(
                  <div className="absolute right-0 mt-2 w-48 bg-gray-800 border border-gray-700 rounded-lg shadow-lg overflow-hidden z-50">
                    ...
                    <a href="/privacy" style={{display:'block',padding:'8px 16px',color:'#8b5cf6',fontSize:13,textDecoration:'none',borderBottom:'1px solid #374151'}}>?? Privacy Center</a>
