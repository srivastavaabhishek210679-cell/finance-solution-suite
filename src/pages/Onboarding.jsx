...
export default function Onboarding() {
  ...
  if(loading) return (
    <div style={{minHeight:'100vh',background:'#f1f5f9',display:'flex',alignItems:'center',justifyContent:'center',color:'#1e293b',fontFamily:'Inter,sans-serif'}}>
    ...
    <div style={{minHeight:'100vh',background:'#f1f5f9',fontFamily:'Inter,sans-serif',color:'#1e293b'}}>
      ...
      <div style={{padding:24,maxWidth:1100,margin:'0 auto'}}>
        ...
        {step===1 && (
          <div>
            <div style={{marginBottom:24}}>
              <h2 style={{color:'#1e293b',fontSize:22,fontWeight:700,margin:'0 0 8px'}}>Select Your Work Modules</h2>
            ...
            <div style={{display:'flex',gap:12,marginBottom:20,alignItems:'center'}}>
              <div style={{display:'flex',alignItems:'center',gap:8,background:'#ffffff',border:'1px solid #e2e8f0',borderRadius:8,padding:'8px 14px',flex:1}}>
                ...
                <input value={search} onChange={e=>setSearch(e.target.value)} placeholder="Search modules..." style={{background:'none',border:'none',color:'#1e293b',fontSize:14,outline:'none',flex:1}}/>
              </div>
        ...
        {step===2 && (
          <div>
            <div style={{marginBottom:24}}>
              <h2 style={{color:'#1e293b',fontSize:22,fontWeight:700,margin:'0 0 8px'}}>Select Reports to Work With</h2>
                ...
                return (
                  <div key={domain} style={{background:'#ffffff',border:'1px solid #e2e8f0',borderRadius:12,overflow:'hidden'}}>
                    <div style={{padding:'12px 16px',display:'flex',alignItems:'center',gap:12,cursor:'pointer'}} onClick={()=>toggleDomainExpand(domain_id)}>
                      ...
                      <span style={{color:'#1e293b',fontWeight:600,fontSize:14,flex:1}}>{domain}</span>
        ...
        {step===3 && (
          <div>
            <div style={{marginBottom:24}}>
              <h2 style={{color:'#1e293b',fontSize:22,fontWeight:700,margin:'0 0 8px'}}>Confirm Your Workspace</h2>
            ...
            <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:20,marginBottom:24}}>
              <div style={{background:'#ffffff',border:'1px solid #e2e8f0',borderRadius:12,padding:20}}>
                <h3 style={{color:'#1e293b',margin:'0 0 16px',fontSize:15,display:'flex',justifyContent:'space-between'}}>
