...
import { TrendingUp, TrendingDown, FileText, CheckCircle, AlertTriangle, BarChart3, Clock } from 'lucide-react'
...
function Dashboard() {
  ...
  const displayReports = Object.keys(activeFilters).length > 0 ? filteredReports : reports

  const handlePageChange = (newPage) => {
    fetchReports(newPage, 20)
