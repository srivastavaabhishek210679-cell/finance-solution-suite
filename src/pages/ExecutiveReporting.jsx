        ...
        <div className="er-exec" style={{ flexDirection:'row', gap:20 }}>
          ...
          <div style={{ width:260, flexShrink:0, display:'flex', flexDirection:'column', gap:14 }}>
            <div style={{ background:'#ffffff', border:'1px solid #e2e8f0', borderRadius:12, padding:16, display:'flex', flexDirection:'column', gap:12 }}>
              <div style={{ fontSize:13, fontWeight:700, color:'#1e293b', display:'flex', alignItems:'center', gap:6 }}><Brain size={13}/> Configure</div>
          ...
          {showForm && (
            <div style={{ background:'#ffffff', border:'1px solid #e2e8f0', borderRadius:10, padding:18, display:'flex', flexDirection:'column', gap:12 }}>
              <div style={{ display:'flex', justifyContent:'space-between', alignItems:'center' }}>
                <span style={{ fontSize:14, fontWeight:700, color:'#1e293b' }}>New Scheduled Report</span>
      ...
      {activeTab==='drilldown' && !boardroom && (
        <div className="er-exec">
          ...
          <div style={{ display:'flex', alignItems:'center', gap:6, padding:'8px 12px', background:'#ffffff', border:'1px solid #e2e8f0', borderRadius:8, fontSize:12 }}>
            ...
            {drillDomain && <><ChevronRight size={12} style={{ color:'#475569' }}/><span style={{ color:'#1e293b', fontWeight:600 }}>{drillDomain}</span></>}
          </div>
              ...
              {DOMAIN_PERF.map(d => (
                ...
                >
                  <div style={{ display:'flex', justifyContent:'space-between', marginBottom:8 }}>
                    <span style={{ fontSize:14, fontWeight:700, color:'#1e293b' }}>{d.domain}</span>
                ...
                <div style={{ background:'#ffffff', border:'1px solid #e2e8f0', borderRadius:10, overflow:'hidden' }}>
                  ...
                  {reports.map((r,i) => (
                    <div key={i} style={{ display:'flex', alignItems:'center', gap:10, padding:'8px 16px', borderBottom:'1px solid #1e293b', borderLeft:`3px solid ${domain?.color}` }}>
                      <span style={{ flex:1, fontSize:12, color:'#1e293b' }}>{r.name||r.report_name}</span>
